# -*- coding: utf-8 -*-
"""
Created on Thu Feb 12 12:15:06 2026
...
"""
version que se adapta
def recibidor(ciudad, pais, poblacion = ' '):
    ciudad = input('Ingrese nombre ciudad')
    pais = input('Ingrese país')
    poblacion = input('Ingrese poblacion')
    if poblacion:
        mensaje = f"{ciudad.capitalize()} es una Ciudad de {pais.capitalize()} y una poblacion de  {poblacion} habitantes"
    else:
